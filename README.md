...
The pre-release of NanoXLSX is now available as [Nuget Package](https://www.nuget.org/packages/NanoXLSX/3.0.0-rc.7), version **3.0.0-rc.7**.
Since there are breaking changes between NanoXLSX v2.x and v3.0.0-rc7, please see the **[Migration guide](MigrationGuide.md)**, to migrate applications from v2 to v3. Please feel free to open issues, in case of problems with the pre-release.
